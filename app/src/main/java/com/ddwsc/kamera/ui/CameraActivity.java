...
import com.ddwsc.kamera.camera.ReferenceCamera;
import com.ddwsc.kamera.camera.ReferenceCamera1;
import com.ddwsc.kamera.camera.ReferenceCamera2;
import com.ddwsc.kamera.common.PermissionHelper;
import com.ddwsc.kamera.data.BeautyItemData;
import com.ddwsc.kamera.model.ItemModel;
import com.ddwsc.kamera.network.DownloadAsyncResponse;
import com.ddwsc.kamera.network.DownloadAsyncTask;
import com.ddwsc.kamera.rendering.CameraTexture;
import com.ddwsc.kamera.rendering.ScreenRenderer;
import com.ddwsc.kamera.util.FileDeleteAsyncTask;
import com.ddwsc.kamera.util.MediaStoreUtil;
import com.ddwsc.kamera.util.PreferenceUtil;
import com.ddwsc.kamera.viewmodel.ContentsViewModel;
import com.ddwsc.kamera.ui.FilterFragment;
...
import com.ddwsc.kamera.R;
import com.ddwsc.kamera.databinding.ActivityCameraBinding;
...
public class CameraActivity extends AppCompatActivity {
    ...
    private void initGLView() {
        final FrameLayout cameraLayout = findViewById(R.id.camera_layout); // layout nơi hiển thị preview camera (live camera)
        FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);

        mGlView = new GLView(this, glViewListener); //GLView class extends GLSurfaceView để phục vụ việc render
        mGlView.setZOrderMediaOverlay(true);

        cameraLayout.addView(mGlView, params); // add view vào layout nơi hiển thị live camera
    }
    // khởi tạo Camera (Camera1 API hoặc Camera2 API)
...
//                break;
            ...
            case R.id.bulge_button:
                showBulge();
                break;
            case R.id.shutter_button: { // chụp ảnh/quay video
            ...
            case R.id.shutter_photo_button: { // đổi view sang dạng chụp ảnh
            ...
            case R.id.shutter_video_button: { //đổi view sang dạng quay video
            ...
            case R.id.camera_switch_button: // thay đổi camera trước và sau
                mARGSession.pause();
    ...
    // layout của các effect, ẩn nếu không được gọi
    ...
    private void showGallery() {
        TedBottomSheetDialogFragment.OnImageSelectedListener picker = new TedBottomPicker.OnImageSelectedListener() {
            @Override
    ...
    // set filter/effect vào đối tượng
    ...
    // áp sticker vào đối tượng trong camera
    ...
    // xoá toàn bộ filter/effect/mark
    ...
    // áp filter vào đối tượng trong camera
    ...
    // tải các filter/effect từ service của ARGear và áp vào đối tượng trong camera
        ...
        new DownloadAsyncTask(targetPath, url, new DownloadAsyncResponse() {
            ...
            public void processFinish(boolean result) {
                ...
                if (result) {
                    ...
                    Log.d("item_download", "downloaded");
                } else {
    ...
    GLView.GLViewListener glViewListener = new GLView.GLViewListener() {
        ...
        public void onDrawFrame(GL10 gl, int width, int height) {
            ...
            mScreenRenderer.draw(frame, width, height); // hiển thị hình ảnh camera thu được lên preview frame
